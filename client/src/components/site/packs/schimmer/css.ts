...
@media(max-width:640px){.pb-sc-chip{display:none}.pb-sc-ring{display:none}.pb-sc-orb-1{width:220px;height:220px}.pb-sc-orb-2{width:160px;height:160px}.pb-sc-orb-3{width:96px;height:96px}.pb-sc-orbs-tr{top:-40px;right:-60px}.pb-sc-orbs-bl{bottom:-36px;left:-60px}.pb-sc-glass{max-width:100%;padding:28px 22px 30px}.pb-sc-hero-grid{grid-template-columns:1fr;gap:24px}.pb-sc-hero-img{max-width:100%;justify-self:stretch}.pb-sc-hero-img img{aspect-ratio:3/2;max-height:60vw}.pb-sc-contact{grid-template-columns:1fr}.pb-sc-nav{flex-wrap:wrap;row-gap:10px;border-radius:20px}.pb-sc-nav-links{margin-left:0}.pb-sc-about{grid-template-columns:1fr;gap:20px}.pb-sc-about-img{order:-1;max-height:55vw}}
