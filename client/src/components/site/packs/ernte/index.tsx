  ...
  switch (section.type) {
    ...
    case "services": {
      return (
        <section
          ...
          key={section.type}
        >
          <h2 className="pb-er-title">{rich(section.headline ?? "")}</h2>
    ...
    case "gallery": {
      ...
      return (
        <section
          ...
          key={section.type}
        >
          <h2 className="pb-er-title">{rich(title ?? "")}</h2>
          <div
    ...
    case "contact": {
      ...
      return (
        ...
        >
          <h2 className="pb-er-title">{rich(title ?? "")}</h2>
          <div className="pb-er-contact" data-pb-slot={LAYOUT_SLOT.contactGrid}>
            <address>
