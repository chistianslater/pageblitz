...
.pb-ml-about{display:grid;gap:24px}
.pb-ml-about-img{width:100%;max-width:480px;border-radius:var(--pb-radius-card);display:block;object-fit:cover;height:280px}
.pb-ml-about p{max-width:64ch;color:var(--pb-ink)}
...
.pb-ml-contact{display:grid;grid-template-columns:1fr 1fr;gap:20px}
