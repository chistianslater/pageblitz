...
const GhostWebsiteCreation = () => {
  ...
  const packName = PACK_SUMMARY.find(p => p.id === packId)?.name ?? packId;
  const IFRAME_W = 1280;
      ...
      >
                ...
                >
                  <div className="relative">
                    ...
                    <div
                      ...
                      style={{
                        animation:
                          "gradient-orb-drift 14s ease-in-out infinite",
                      }}
                    />
        ...
        >
          <div className="max-w-2xl mx-auto px-6 text-center">
            ...
            >
              Gefällt dir, was du siehst? Erstelle jetzt deine eigene Website –
              in 3 Minuten.
            </p>
            <Button
              size="lg"
            ...
            >
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                >
                  ...
                  <strong
                    className={isDark ? "text-white/80" : "text-slate-800"}
                  >
                    Google My Business Link
                  </strong>{" "}
                  einfügen – Name, Adresse, Öffnungszeiten, Fotos und
                  Bewertungen werden automatisch übernommen. Kein Abtippen, kein
                  Aufwand.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="relative">
                <div
                  ...
                  style={{
                    animation:
                      "gradient-orb-drift-alt 16s ease-in-out infinite",
                  }}
                />
                <div
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                >
                  Kein Telefonieren, kein Hin-und-Her per WhatsApp. Kunden
                  wählen einfach ihren Wunschtermin – du siehst alles in deinem
                  Kalender. Kostet weniger als eine Tasse Kaffee pro Monat.
                </m.p>
              </div>
              <m.button
