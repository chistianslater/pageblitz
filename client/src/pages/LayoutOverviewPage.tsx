...
const LAYOUTS = [
  {
    ...
    headline: "Barlow Condensed 900",
    body: "Barlow 400",
    bg: "#0A0A0A",
    text: "#FFFFFF",
    accent: "#E8C13A",
    description: "Industrielle Wucht – brutalistisches Raster, diagonaler Hero-Cut, nummerierte Leistungsliste.",
  },
  {
    key: "ELEGANT",
    label: "Elegant",
    ...
    text: "#2A2018",
    accent: "#967B5C",
    description: "Pariser Editorial – riesiger schwebender Anfangsbuchstabe, serifige Kursivtype, Haarlinien.",
  },
  {
    key: "CLEAN",
    label: "Clean",
    ...
    text: "#0F172A",
    accent: "#1B3D6F",
    description: "Klinische Präzision – versetztes Bild, farbige linke Randlinie bei Services, Vertrauens-Badge.",
  },
  {
    key: "CRAFT",
    label: "Craft",
  ...
  },
  {
    ...
    headline: "Libre Baskerville italic",
    body: "Jost 300",
    bg: "#0C0A09",
    text: "#F5F5F0",
    accent: "#C9A43A",
    description: "Fashion-Editorial – Vollbild-Kino-Hero, maximaler Weißraum, dünne Goldlinien.",
  },
  {
    key: "MODERN",
    label: "Modern",
    industry: "IT & Agentur",
    headline: "Syne 800",
    body: "DM Sans 400 + Space Mono",
    bg: "#FFFFFF",
    text: "#111827",
    accent: "#2563EB",
    description: "Tech-Geometrie – Monospace-Akzente, schwebendes Code-Badge, geometrischer Blob.",
  },
  {
    key: "NATURAL",
    label: "Natural",
    industry: "Bio & Natur",
    headline: "Lora 700 italic",
    body: "Source Sans 3 400",
    bg: "#F4F0E8",
    text: "#2D2A20",
    accent: "#3D5A4C",
    description: "Botanisch-organisch – pillenförmige Bilder-Paare, Blatt-Icon, weiche Erdtöne.",
  },
  {
    key: "PREMIUM",
    label: "Premium",
