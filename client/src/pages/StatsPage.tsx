      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            <StatusBar
              label="Preview"
              value={stats?.previewCount ?? 0}
              total={stats?.totalWebsites ?? 1}
              color="bg-amber-400"
              icon={Eye}
            />
            <StatusBar
    ...
    <Card className="bg-card border-border">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Eingegebene Branchen ohne passendes Style-Pack — Kandidaten für neue
          Templates, häufigste zuerst.
        </p>
      </CardHeader>
      <CardContent>
        {isLoading ? (
          ...
          <p className="text-sm text-muted-foreground">
            Keine Lücken erfasst — bisher hat jede eingegebene Branche ein Pack
            gefunden.
          </p>
        ) : (
