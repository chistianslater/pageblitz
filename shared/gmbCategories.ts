...
const GMB_CATEGORY_MAP: Record<string, string> = {
  ...
  "Scaffolding contractor": "Gerüstbauer",
  "Plumber": "Sanitärinstallateur",
  "Sanitary engineer": "Sanitärinstallateur",
  "Stucco contractor": "Stuckateur",
  "Carpenter": "Zimmermann",
  "Glazier": "Glaser",
  "Well drilling contractor": "Brunnenbauer",
  "Pest control service": "Schädlingsbekämpfung",
  "Pool cleaning service": "Poolreinigung",
  "Solar energy company": "Photovoltaik",
  "Solar panel installer": "Photovoltaik",
  ...
  // Industry & B2B
  "Machine shop": "Maschinenbau",
  "Manufacturer": "Produktionsbetrieb",
  "Manufacturing": "Fertigung",
  "Metal fabrication": "Metallverarbeitung",
  "Metal fabricator": "Metallbau",
  "Welding supply store": "Schweißtechnik",
  "Business management consultant": "Unternehmensberatung",
  "Management consultant": "Unternehmensberatung",
  "Business consultant": "Unternehmensberatung",
  "Coach": "Coach",
  "Life coach": "Life Coach",
  "Business coach": "Business Coach",
  "Human resources consultant": "Personalberatung",
  "Bookkeeping service": "Buchhaltung",
  "Payroll service": "Lohnbuchhaltung",
  "Logistics service": "Logistik",
  "Freight company": "Spedition",
  "Warehouse": "Lagerhaltung",

  // Pets & Animals
  "Dog groomer": "Hundesalon",
  "Dog grooming service": "Hundesalon",
  "Pet groomer": "Tiersalon",
  "Dog trainer": "Hundetrainer",
  "Dog training school": "Hundeschule",
...
export const CATEGORY_GROUPS: Array<{ group: string; icon: string; categories: string[] }> = [
  ...
  },
  {
    ...
    categories: [
      ...
      "Physiotherapeut", "Chiropraktiker", "Logopäde", "Ergotherapeut",
      "Hebamme", "Podologe", "Hörakustiker", "Hörgeräteakustiker",
      "Hautarzt", "Augenarzt", "Orthopäde", "Gynäkologe", "Kinderarzt",
      "Optiker", "Apotheke", "Krankenhaus", "Klinik", "Arztpraxis",
      "Psychologe", "Therapeut", "Tierarzt", "Tierarztpraxis", "Ernährungsberater",
    ],
  },
  {
    group: "Fitness & Sport",
  ...
  },
  {
    ...
    categories: [
      ...
      "Sanitärinstallateur", "Dachdecker", "Dachdeckerbetrieb", "Maler", "Malerbetrieb",
      "Schreiner", "Zimmermann", "Bodenleger", "Fliesenleger", "Stuckateur", "Glaser",
      "Gartenbauer", "Gartengestaltung", "Heizungsbauer", "Heizung & Klima", "Dämmtechnik",
      "Photovoltaik", "Fensterbauer", "Gerüstbauer", "Schornsteinfeger",
      "Schlüsseldienst", "Umzugsunternehmen", "Reinigungsservice", "Gebäudereinigung",
  ...
  },
  {
    ...
    categories: [
      ...
      "Coach", "Life Coach", "Business Coach",
      "Hundesalon", "Hundetrainer", "Hundeschule", "Hundepension", "Tierheim", "Reitschule",
    ],
  },
  {
    group: "Industrie & B2B",
    icon: "🏭",
    categories: [
      "Maschinenbau", "Metallverarbeitung", "Metallbau", "Fertigung", "Produktionsbetrieb",
      "Schweißtechnik", "Unternehmensberatung", "Personalberatung",
      "Buchhaltung", "Lohnbuchhaltung", "Logistik", "Spedition",
    ],
  },
];
