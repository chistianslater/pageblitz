...
export const LANDGUT: PackConstitution = {
  ...
  llmHints: {
    do: [
      "geerdete, konkrete Sprache mit Naturbezug (Boden, Jahreszeiten, Pflanzen)",
      "kurze, ruhige Sätze wie eine Gartenbeschreibung",
      "Fachbegriffe aus Gärtnerei/Floristik korrekt und sparsam einsetzen",
    ],
    dont: [
