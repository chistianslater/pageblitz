...
import {
  ...
  listTemplateUploads,
  listTemplateUploadsByIndustry,
  listTemplateUploadsByPool,
  deleteTemplateUpload,
  updateTemplateUpload,
  getTemplateUploadById,
  parseIndustries,
  createSubscription,
...
import {
  selectTemplatesForIndustry,
  getTemplateStyleDescription,
...
import {
  getIndustryServicesSeed,
  getIndustryProfile,
} from "@shared/industryServices";
import { shouldRequireAgeGate } from "@shared/ageGate";
import {
  getLayoutFonts,
  getLLMFontPrompt,
  FORBIDDEN_BODY_FONTS,
  DESIGN_TOKEN_CONFIG,
...
function formatOpeningHoursText(
  ...
  while (i < open.length) {
    ...
    const slot2 =
      open[i].from2 && open[i].to2
        ? `, ${open[i].from2} – ${open[i].to2} Uhr`
        : "";
...
const DESIGN_ARCHETYPES: Record<
  string,
  {
    name: string;
    designTwin: string;
...
> = {
  elegant: {
    ...
    aesthetic:
      "Elegant, reduziert, luxuriös. Großzügiger Weißraum, klassische Serifen, hochwertige Bilder.",
    colors: {
      primary: "#1A1A1A",
      background: "#FDFBF7",
      accent: "#D4AF37",
...
Vibe: Teuer, zeitlos, sophisticated. Weniger ist mehr.`,
  ...
  fresh: {
    ...
    aesthetic:
      "Einladend, freundlich, zugänglich. Warme Pastelle, abgerundete Formen, authentische Fotografie.",
    colors: {
      primary: "#E07B53",
      background: "#FDF8F4",
      accent: "#F4A261",
    ...
    typography: {
      headers: "Plus Jakarta Sans, sans-serif",
...
Vibe: Menschlich, fürsorglich, zugänglich. Wie ein freundlicher Nachbar.`,
  ...
  luxury: {
    ...
    aesthetic:
      "Filmisch, emotional, atmosphärisch. Video-first, sanfte Animationen, dunkle Atmosphäre.",
    colors: {
      primary: "#0F141A",
      background: "#0F141A",
      accent: "#C9A84C",
...
Vibe: Filmisch, mysteriös, emotional. Wie ein Kinotrailer.`,
  ...
  bold: {
    ...
    aesthetic:
      "Kraftvoll, direkt, starke Kontraste. Große Typografie, asymmetrische Layouts, schwarzer Hintergrund.",
    colors: {
      primary: "#FF4500",
      background: "#0A0A0A",
      accent: "#FF4500",
...
Vibe: Roh, selbstbewusst, rebellisch. Wie ein Schlag ins Gesicht (positiv).`,
  ...
  craft: {
    ...
    aesthetic:
      "Authentisch, handwerklich, nostalgisch. Texturierte Hintergründe, Vintage-Typografie, Wärme.",
    colors: {
      primary: "#8B4513",
      background: "#FFF8DC",
      accent: "#CD5C5C",
...
Vibe: Nostalgisch, handwerklich, authentisch. Wie ein Familienbetrieb seit 1952.`,
  ...
  modern: {
    ...
    aesthetic:
      "Minimalistisch, technisch, fokussiert. Dunkle Hintergründe, klare Hierarchie, Bento-Grid.",
    colors: {
      primary: "#6366F1",
      background: "#0A0A0A",
      accent: "#6366F1",
...
Vibe: Präzision, Ingenieurskunst, High-Tech. Wie ein Produkt von einem Top-Startup.`,
  ...
  trust: {
    ...
    aesthetic:
      "Seriös, strukturiert, vertrauenswürdig. Navy-Farben, klare Grids, Business-Fotografie.",
    colors: {
      primary: "#1E3A5F",
      background: "#FFFFFF",
      accent: "#38B2AC",
    ...
    typography: {
      headers: "Instrument Sans, sans-serif",
      body: "Inter, sans-serif",
    },
...
Vibe: Vertrauenswürdig, etabliert, seriös. Wie ein Marktführer.`,
  ...
  vibrant: {
    ...
    aesthetic:
      "Dynamisch, magazinähnlich, informationsdicht. Starke Typografie, Parallax, Bewegung.",
    colors: {
      primary: "#FF4500",
      background: "#0D0D0D",
      accent: "#FFD700",
...
Vibe: Laut, selbstbewusst, buzz-worthy. Wie eine Werbeagentur.`,
  ...
  natural: {
    ...
    aesthetic:
      "Naturverbunden, nachhaltig, erdige Farben, organische Formen, Naturbilder.",
    colors: {
      primary: "#4A7C59",
      background: "#F5F0E8",
      accent: "#8B6914",
...
Vibe: Nachhaltig, clean, natürlich. Wie ein Bio-Unternehmen mit Stil.`,
  ...
  dynamic: {
    ...
    aesthetic:
      "Verspielt, bunt, gamifiziert. Lebhafte Farben, abgerundete Elemente, spielerische Animationen.",
    colors: {
      primary: "#6366F1",
      background: "#FAFAFA",
      accent: "#EC4899",
...
Vibe: Spaßig, engagierend, erfrischend. Wie eine App die man gerne benutzt.`,
  ...
  warm: {
    ...
    aesthetic:
      "Sensorisch, appetitanregend, gemütlich. Warme Erdtöne, Foodfoto-Atmosphäre.",
    colors: {
      primary: "#C0392B",
      background: "#FDF6EC",
      accent: "#E67E22",
...
Vibe: Appetitanregend, gemütlich, premium. Wie ein Restaurant das man sofort besuchen will.`,
  ...
  clean: {
    ...
    aesthetic:
      "Klar, professionell, vertrauenswürdig. Viel Weißraum, strukturierte Navigation, Blau-Akzente.",
    colors: {
      primary: "#2563EB",
      background: "#FFFFFF",
      accent: "#0EA5E9",
...
function buildIndustryContext(
  ...
  if (
    /friseur|salon|beauty|hair|barber|coiffeur|nail|spa|massage|kosmetik|wellness|ästhetik|lash|brow|make.?up|tanning|waxing|threading/.test(
      combined
    )
  ) {
...
VERBOTEN: "Ihr Wohlbefinden liegt uns am Herzen", "Wir freuen uns auf Ihren Besuch", generische Phrasen.`;
  ...
  if (
    /\bbar\b|tapas|cocktail|lounge|pub|kneipe|weinbar|brauerei|brewery|nightlife|nachtleben|aperitivo/.test(
      combined
    )
  ) {
...
VERBOTEN: "Wir bieten eine große Auswahl", generische Gastro-Phrasen.`;
  ...
  if (
    /restaurant|gastro|cafe|café|bistro|pizza|küche|bäckerei|catering|food|sushi|burger|gastronomie|bakery/.test(
      combined
    )
  ) {
...
VERBOTEN: "Wir bieten eine große Auswahl", "für jeden Geschmack etwas dabei", generische Phrasen.`;
  ...
  if (
    /bauunternehmen|baufirma|hochbau|tiefbau|rohbau|bauträger|generalunternehmer|schlüsselfertig|neubau|umbau|anbau/.test(
      combined
    )
  ) {
...
VERBOTEN: "Qualität steht bei uns an erster Stelle", "Ihr Partner für...", weiche Phrasen.`;
  ...
  if (
    /handwerk|elektriker|klempner|maler|bau|sanitär|dachdecker|contractor|roofing|construction|tischler|schreiner|zimmermann|fliesenleger|renovation|installation/.test(
      combined
    )
  ) {
...
VERBOTEN: "Wir sind Ihr Partner für...", "Qualität steht bei uns an erster Stelle", weiche Phrasen.`;
  ...
  if (
    /auto|kfz|car|garage|mechanic|werkstatt|karosserie|tuning|fahrzeug|vehicle|motorrad|motorcycle|reifenservice/.test(
      combined
    )
  ) {
...
Services: Konkrete Leistungen mit technischen Details und Zeitangaben.`;
  ...
  if (
    /fitness|gym|sport|yoga|training|crossfit|pilates|kampfsport|tanzen|personal.?trainer|physiotherap|bewegung|martial|boxing/.test(
      combined
    )
  ) {
...
VERBOTEN: "Für jeden das Richtige", "Spaß am Sport", generische Fitness-Phrasen.`;
  ...
  if (
    /arzt|zahnarzt|praxis|medizin|therapie|doctor|dental|clinic|health|apotheke|klinik|hospital|chiropractor|heilpraktiker/.test(
      combined
    )
  ) {
...
VERBOTEN: "Ihr Vertrauen ist unser Kapital", "Wir nehmen uns Zeit für Sie", generische Phrasen.`;
  ...
  if (
    /rechtsanwalt|anwalt|kanzlei|steuerberater|beratung|consulting|law|legal|finanz|versicherung|immobilien|makler/.test(
      combined
    )
  ) {
...
Services: Konkrete Leistungsbereiche mit Spezialisierungen.`;
  ...
  if (
    /bio|organic|öko|eco|natur|garden|garten|florist|blumen|flower|pflanze|plant|naturopath|kräuter|herb|nachhaltig|sustainable/.test(
      combined
    )
  ) {
...
Services: Konkrete Produkte/Leistungen mit Herkunftsangaben.`;
  ...
  if (
    /tech|software|digital|agency|agentur|web|app|it|computer|marketing|design|media|kreativ|creative|startup/.test(
      combined
    )
  ) {
...
Services: Konkrete Leistungen mit messbaren Ergebnissen.`;
  ...
  if (
    /hotel|pension|hostel|airbnb|tourism|tourismus|event|veranstaltung|hochzeit|wedding|party|reise|travel/.test(
      combined
    )
  ) {
...
function buildPersonalityHint(
  ...
  if (rating && parseFloat(rating) >= 4.5) {
    parts.push(
      `Das Unternehmen hat ausgezeichnete Bewertungen (${rating}/5 bei ${reviewCount} Bewertungen) – betone diese Stärke prominent.`
    );
  } else if (rating && parseFloat(rating) >= 4.0) {
    parts.push(
      `Das Unternehmen hat gute Bewertungen (${rating}/5) – erwähne Kundenzufriedenheit.`
    );
  }
  if (reviewCount > 100) {
    parts.push(
      `Mit ${reviewCount}+ Bewertungen ist das Unternehmen etabliert und bekannt in der Region.`
    );
  }
  // Name-based hints
  ...
  if (lowerName.match(/\b(meister|master|expert|profi)\b/)) {
    parts.push(
      `Der Name deutet auf besondere Expertise hin – betone Meisterqualität.`
    );
  }
  if (lowerName.match(/\b(familie|family|familien)\b/)) {
    parts.push(
      `Familienunternehmen – betone persönliche, familiäre Atmosphäre und Tradition.`
    );
  }
  return parts.join(" ");
}
...
function buildEnhancedPrompt(opts: {
  ...
  const archetype =
    DESIGN_ARCHETYPES[layoutStyle] || DESIGN_ARCHETYPES["modern"];
...
function mapCategoryToIndustryKey(category: string): string {
  ...
  if (
    /friseur|salon|beauty|hair|barber|coiffeur|nail|spa|massage|kosmetik|wellness|lash|brow|make.?up/.test(
      lower
    )
  )
    return "beauty";
  if (
    /\bbar\b|tapas|cocktail|lounge|pub|kneipe|weinbar|brauerei|brewery|nightlife|aperitivo/.test(
      lower
    )
  )
    return "restaurant";
  if (
    /café|cafe|bistro|kaffee|coffee|coffeeshop|bäckerei|bakery|konditorei|patisserie|brunch/.test(
      lower
    )
  )
    return "restaurant";
  if (
    /restaurant|gastro|gastronomie|pizza|küche|bäckerei|catering|food|sushi|burger|bakery/.test(
      lower
    )
  )
    return "restaurant";
  if (
    /fitness|gym|sport|yoga|training|crossfit|pilates|kampfsport|personal.?trainer|physiotherap|boxing/.test(
      lower
    )
  )
    return "fitness";
  if (
    /auto|kfz|car|garage|mechanic|werkstatt|karosserie|tuning|motorrad|reifenservice/.test(
      lower
    )
  )
    return "automotive";
  if (
    /arzt|zahnarzt|praxis|medizin|therapie|doctor|dental|clinic|health|apotheke|klinik|chiropractor/.test(
      lower
    )
  )
    return "medical";
  if (
    /rechtsanwalt|anwalt|kanzlei|steuerberater|beratung|consulting|law|legal|finanz|versicherung|immobilien/.test(
      lower
    )
  )
    return "legal";
  if (
    /bauunternehmen|baufirma|hochbau|tiefbau|rohbau|bauträger|generalunternehmer|schlüsselfertig|neubau/.test(
      lower
    )
  )
    return "trades";
  if (
    /handwerk|elektriker|klempner|maler|bau|sanitär|dachdecker|roofing|construction|tischler|schreiner/.test(
      lower
    )
  )
    return "trades";
  if (
    /tech|software|digital|agency|agentur|web|app|it|computer|marketing|design|media|startup/.test(
      lower
    )
  )
    return "tech";
  if (
    /bio|organic|öko|eco|natur|garden|garten|florist|blumen|flower|pflanze|naturopath/.test(
      lower
    )
  )
    return "other";
  if (
    /hotel|pension|hostel|tourism|tourismus|event|veranstaltung|hochzeit|wedding|reise/.test(
      lower
    )
  )
    return "hospitality";
 ...
 */
function buildProcessSection(category: string): {
  headline: string;
  items: Array<{ step: string; title: string; description: string }>;
} {
  const cat = (category || "").toLowerCase();

  if (cat.includes("restaurant") || cat.includes("gastro"))
    return {
      headline: "So einfach geht's",
      items: [
        {
          ...
          title: "Reservieren",
          description:
            "Tisch online, per Telefon oder App reservieren – auch kurzfristig möglich.",
        },
        {
          step: "2",
          title: "Ankommen",
          description:
            "Herzliche Begrüßung und persönlicher Service von Anfang an.",
        },
        {
          step: "3",
          title: "Genießen",
          description:
            "Frische Küche und aufmerksamer Service für einen unvergesslichen Abend.",
        },
      ],
    };
  if (
      ...
      items: [
        {
          ...
          title: "Reinkommen",
          description:
            "Einfach vorbeikommen – Reservierung ist auf Wunsch auch möglich.",
        },
        {
          step: "2",
          title: "Auswählen",
          description:
            "Frische Backwaren, Spezialitäten und hochwertige Kaffeespezialitäten genießen.",
        },
        {
          step: "3",
          title: "Entspannen",
          description: "Genuss und Pause in gemütlicher Atmosphäre.",
        },
      ],
    };
  if (cat.includes("bar") || cat.includes("tapas") || cat.includes("lounge"))
    return {
      ...
      items: [
        {
          ...
          description:
            "Online oder telefonisch Ihren Platz für den Abend sichern.",
        },
        {
          step: "2",
          title: "Ankommen & bestellen",
          description:
            "Entspannte Atmosphäre, handgemachte Drinks und ein aufmerksames Team.",
        },
        {
          step: "3",
          title: "Unvergesslicher Abend",
          description:
            "Gute Gesellschaft, tolle Musik und ein Abend, der in Erinnerung bleibt.",
        },
      ],
    };
      ...
      items: [
        {
          ...
          title: "Termin buchen",
          description:
            "Einfach online oder telefonisch Ihren Wunschtermin auswählen.",
        },
        {
          step: "2",
          title: "Beratung & Styling",
          description:
            "Persönliche Stilberatung und professionelle Umsetzung Ihres Wunsch-Looks.",
        },
        {
          step: "3",
          title: "Strahlendes Ergebnis",
          description:
            "Sie verlassen den Salon mit einem frischen, gepflegten Erscheinungsbild.",
        },
      ],
    };
  if (
    cat.includes("beauty") ||
    cat.includes("kosmetik") ||
    cat.includes("nails") ||
      ...
      items: [
        {
          ...
          title: "Termin buchen",
          description:
            "Online oder telefonisch schnell und unkompliziert reservieren.",
        },
        {
          step: "2",
          title: "Ankommen & Entspannen",
          description:
            "Wir empfangen Sie herzlich und kümmern uns um jedes Detail.",
        },
        {
          step: "3",
          title: "Verwöhnendes Ergebnis",
          description:
            "Sie gehen entspannt und gepflegt – genau so, wie Sie es verdienen.",
        },
      ],
    };
  if (
    ...
    cat.includes("renovier") ||
    cat.includes("maler") ||
    cat.includes("elektro") ||
    cat.includes("sanitär") ||
    cat.includes("heizung") ||
    cat.includes("zimmerer") ||
    cat.includes("schreiner") ||
    cat.includes("tischler")
  )
    return {
      ...
      items: [
        {
          ...
          description:
            "Beschreiben Sie Ihr Projekt – wir melden uns innerhalb von 24 Stunden.",
        },
        {
          step: "2",
          title: "Kostenvoranschlag",
          description:
            "Transparenter Festpreis nach Besichtigung – keine versteckten Kosten.",
        },
        {
          step: "3",
          title: "Saubere Ausführung",
          description:
            "Pünktliche, professionelle Arbeit mit Qualitätsgarantie.",
        },
      ],
    };
  if (
      ...
      items: [
        {
          ...
          description:
            "Lerne uns kennen – unverbindlich und ohne Mitgliedschaft.",
        },
        {
          step: "2",
          title: "Persönlicher Trainingsplan",
          description:
            "Individuell auf deine Ziele, deinen Körper und deine Zeit abgestimmt.",
        },
        {
          step: "3",
          title: "Sichtbare Ergebnisse",
          description:
            "Mit konsequentem Training und Unterstützung erreichst du deine Ziele.",
        },
      ],
    };
  if (
      ...
      items: [
        {
          ...
          description:
            "Online oder telefonisch schnell und einfach einen Termin buchen.",
        },
        {
          step: "2",
          title: "Untersuchung & Beratung",
          description:
            "Sorgfältige Untersuchung und ausführliche Beratung in angenehmer Atmosphäre.",
        },
        {
          step: "3",
          title: "Behandlung & Nachsorge",
          description:
            "Professionelle Behandlung und persönliche Begleitung auf dem Weg zur Genesung.",
        },
      ],
    };
  if (
      ...
      items: [
        {
          ...
          description:
            "Schildern Sie Ihr Anliegen – das erste Beratungsgespräch ist kostenfrei.",
        },
        {
          step: "2",
          title: "Fallanalyse",
          description:
            "Wir prüfen Ihre Situation und entwickeln die optimale Strategie.",
        },
        {
          step: "3",
          title: "Durchsetzung Ihrer Rechte",
          description:
            "Professionelle Vertretung und Begleitung bis zur erfolgreichen Lösung.",
        },
      ],
    };
  if (cat.includes("immobil") || cat.includes("makler"))
    return {
      ...
      items: [
        {
          ...
          description:
            "Wir besprechen Ihre Wünsche und Ihr Budget in einem persönlichen Gespräch.",
        },
        {
          step: "2",
          title: "Gezielte Suche",
          description:
            "Wir präsentieren passende Objekte aus unserem Netzwerk.",
        },
        {
          step: "3",
          title: "Erfolgreicher Abschluss",
          description:
            "Von der Besichtigung bis zur Schlüsselübergabe – wir begleiten jeden Schritt.",
        },
      ],
    };
  if (
    cat.includes("fotograf") ||
    cat.includes("photo") ||
    cat.includes("video") ||
    cat.includes("film")
  )
      ...
      items: [
        {
          ...
          description:
            "Erzählen Sie uns von Ihrem Wunschprojekt – kostenlose Erstberatung.",
        },
        {
          step: "2",
          title: "Planung & Vorbereitung",
          description:
            "Gemeinsam planen wir Konzept, Locations und Ablauf für perfekte Ergebnisse.",
        },
        {
          step: "3",
          title: "Fotos & Erinnerungen",
          description:
            "Professionell bearbeitete Bilder – pünktlich geliefert in höchster Qualität.",
        },
      ],
    };
  if (
      ...
      items: [
        {
          ...
          title: "Termin buchen",
          description:
            "Online oder telefonisch schnell einen Termin vereinbaren.",
        },
        {
          step: "2",
          title: "Diagnose & Angebot",
          description:
            "Wir prüfen Ihr Fahrzeug und erstellen einen transparenten Kostenvoranschlag.",
        },
        {
          step: "3",
          title: "Abfahrbereit",
          description:
            "Professionelle Reparatur und Wartung – Ihr Fahrzeug wartet auf Sie.",
        },
      ],
    };
  if (
    ...
    cat.includes("unterkunft") ||
    cat.includes("ferienwohnung")
  )
    return {
      ...
      items: [
        {
          ...
          title: "Zimmer buchen",
          description:
            "Einfach online oder telefonisch Ihren Aufenthalt reservieren.",
        },
        {
          step: "2",
          title: "Ankommen & Wohlfühlen",
          description:
            "Herzlicher Empfang und komfortable Zimmer in entspannter Atmosphäre.",
        },
        {
          step: "3",
          title: "Unvergesslicher Aufenthalt",
          description:
            "Persönlicher Service und alle Annehmlichkeiten für Ihre Erholung.",
        },
      ],
    };
  if (
      ...
      items: [
        {
          ...
          description:
            "Beschreiben Sie Ihr Projekt oder Problem – wir melden uns schnell.",
        },
        {
          step: "2",
        ...
        {
          step: "3",
          title: "Umsetzung & Support",
          description:
            "Professionelle Umsetzung und langfristiger Support für Ihren Erfolg.",
        },
      ],
    };
  // Universal fallback
    ...
    items: [
      {
        ...
        description:
          "Schreiben Sie uns oder rufen Sie an – wir antworten schnell und unkompliziert.",
      },
      {
        step: "2",
        title: "Persönliche Beratung",
        description:
          "Wir analysieren Ihre Situation und zeigen Ihnen die beste Lösung.",
      },
      {
        step: "3",
        title: "Professionelles Ergebnis",
        description:
          "Wir setzen Ihr Projekt um – zuverlässig, pünktlich und mit Qualitätsgarantie.",
      },
    ],
  };
}
...
function buildVerifiedStats(
  ...
  if (business.rating && parseFloat(business.rating) >= 3) {
    stats.push({
      title: `${parseFloat(business.rating).toFixed(1)}★`,
  ...
  if (business.openingHours && Array.isArray(business.openingHours)) {
    const openDays = (business.openingHours as string[]).filter(
      (h: string) =>
        h &&
        !h.toLowerCase().includes("geschlossen") &&
  ...
  if (stats.length < 4) {
    const extra =
      cat.includes("fitness") || cat.includes("sport")
...
function getFallbackWebsiteData(
  business: any,
  category: string,
  colorScheme: any,
  layoutStyle: string
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: "Service",
            description: "Professioneller Service mit Qualitätsgarantie",
            icon: "Star",
          },
          {
            title: "Support",
            description: "Langfristige Betreuung und Support",
            icon: "Heart",
          },
        ],
      },
...
export async function runWebsiteGeneration(
  ...
  try {
    ...
    const { pool: layoutPool } = getLayoutPool(
      category,
      business.name,
      industryKey
    );
    ...
    const [heroImageUrl, galleryImages, gmbPhotos, matchingTemplates] =
      await Promise.all([
    ...
    const uploadedImageUrls = uploadedTemplates
      .slice(0, 3)
      .map((t: any) => t.imageUrl);
    const templateImageUrls = [
      ...uploadedImageUrls,
      ...baseTemplateImageUrls,
    ].slice(0, 3); // Reduziert auf 3 statt 5
    ...
    try {
          ...
          messages: [
            {
              role: "system",
              content:
                "Du bist ein Webdesigner. Antworte AUSSCHLIESSLICH mit validem JSON.",
            },
              ...
              ? [
                  {
                    ...
                    content: [
                      {
                        type: "text" as const,
                        text: `Design-Referenzen: ${templateImageUrls.length} Templates`,
                      },
      ...
      console.warn(
        `[Generation Job ${jobId}] KI-Fehler, verwende Fallback:`,
        aiError
      );
      websiteData = getFallbackWebsiteData(
        business,
        category,
        colorScheme,
        layoutStyle
    ...
    const finalHeroImageUrl =
      gmbPhotos.length > 0 ? gmbPhotos[0] : heroImageUrl;
    const effectiveGalleryImages =
      gmbPhotos.length >= 3 ? gmbPhotos.slice(1) : galleryImages;
    if (effectiveGalleryImages.length > 0 && websiteData.sections) {
      ...
      if (gallerySection) {
        gallerySection.items = effectiveGalleryImages.map(url => ({
          imageUrl: url,
        }));
    ...
    let storedReviews = (business as any).googleReviews as Array<{
      author_name: string;
      rating: number;
      text: string;
      time: number;
    ...
    console.log(
      `[Generation Job ${jobId}] Completed successfully for website ${websiteId}${useFallback ? " (mit Fallback)" : ""}`
    );
    ...
    try {
      ...
      if (linkedEmail && linkedEmail.status === "generating") {
        ...
        console.log(
          `[Generation Job ${jobId}] Outreach email ${linkedEmail.id} marked as draft (awaiting approval)`
        );
      }
    } catch (e) {
      // Non-critical: don't fail the generation job
      console.error(
        `[Generation Job ${jobId}] Failed to update outreach email:`,
        e
      );
    }
  } catch (error: any) {
      ...
      .mutation(async ({ input }) => {
        ...
        if (!content || typeof content !== "string") {
          throw new TRPCError({
            ...
            message: "KI-Generierung fehlgeschlagen",
          });
        }
        ...
        let storedReviewsRegen = (business as any).googleReviews as Array<{
          author_name: string;
          rating: number;
          text: string;
          time: number;
        ...
        if (
          (!storedReviewsRegen || storedReviewsRegen.length === 0) &&
          business.placeId
        ) {
          const fresh = await getGmbReviews(business.placeId);
          if (fresh.length > 0) {
            storedReviewsRegen = fresh;
            await updateBusiness(business.id, { googleReviews: fresh } as any);
          }
        }
  ...
  "reason": "Kurze Begründung auf Deutsch (max. 2 Sätze)"
          ...
          messages: [
            {
              ...
              content: [
                ...
                {
                  type: "image_url",
                  image_url: { url: template.imageUrl, detail: "low" },
                },
              ],
            },
          ],
        ...
        try {
          ...
          parsed = {
            ...
            layoutPool: "clean",
            confidence: "low",
            reason: "KI-Analyse fehlgeschlagen",
          };
        }
    ...
    bulkApprove: adminProcedure
      ...
      .mutation(async ({ input }) => {
        await Promise.all(
          input.ids.map(id => updateTemplateUpload(id, { status: "approved" }))
        );
    ...
    list: adminProcedure
      ...
      .query(async ({ input }) => {
        const status =
          input?.status === "all" ? undefined : input?.status || undefined;
...
Kontext: ${input.context}`,
    ...
    suggestServices: publicProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const business = await getBusinessById(website.businessId);
        const categoryHint = getCategoryServiceHint(
          business?.category,
          business?.name
        );
          ...
          messages: [
            {
              role: "system",
              content:
                "Du bist ein Experte für lokale Unternehmenswebsites in Deutschland, der das StoryBrand-Framework beherrscht. Leistungen werden als Lösungen für Kundenprobleme formuliert – outcome-focused. Der Titel nennt die Leistung, die Beschreibung nennt den Kundennutzen (was der Kunde erreicht/gewinnt). Antworte immer mit validem JSON.",
            },
            {
              role: "user",
              content: `Schlage 6 verschiedene, typische Leistungen für dieses Unternehmen vor. Jede Leistung: Titel = klare Bezeichnung der Leistung, Beschreibung = was der Kunde dadurch gewinnt/erreicht (max 12 Wörter, Kundenperspektive). Gib nur ein JSON-Array zurück, kein Markdown, keine Erklärung.\n\nFormat: [{\"title\": \"Leistungsname\", \"description\": \"Was der Kunde dadurch gewinnt (max 12 Wörter)\"}]\n\nKontext: ${input.context}${categoryHint}`,
            },
          ],
          response_format: {
            type: "json_schema",
      ...
      .mutation(async ({ input }) => {
        ...
        const domain =
          ...
          (input.websiteUrl
            ? (() => {
                try {
                  return new URL(input.websiteUrl!).hostname.replace(
                    /^www\./,
                    ""
                  );
                } catch {
        ...
        if (hunterKey) {
          try {
            ...
            const generic = emails.find(e =>
              /^(info|kontakt|contact|hallo|hello|mail|post|office|service|anfrage)@/i.test(
                e.value
              )
            );
            const best =
              generic || emails.sort((a, b) => b.confidence - a.confidence)[0];
        ...
        try {
          ...
          const res = await fetch(url, {
            headers: {
              "User-Agent": "Mozilla/5.0 (compatible; Pageblitz/1.0)",
            },
          ...
          const emails = Array.from(
            new Set(matches.map(m => m.replace("mailto:", "").toLowerCase()))
          ).filter(
            e => !e.includes("example.com") && !e.includes("domain.com")
          );
          // Prefer generic emails
          const generic = emails.find(e =>
            /^(info|kontakt|contact|hallo|hello|mail|post|office|service|anfrage)@/.test(
              e
            )
          );
    ...
    saveStep: publicProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        if (safeData.businessCategory) {
          ...
          if (updatedWebsiteData) {
            try {
              ...
              const industryImages = getIndustryImages(
                newCategory,
                bizName,
                industryKey
              );
              ...
              const patchedStr = JSON.stringify(data).replace(
                ...
                match => {
                  ...
                  const idx = Math.floor(
                    Math.random() * allIndustryHeroes.length
                  );
        ...
        if (safeData.brandLogo !== undefined && safeData.brandLogo !== null) {
          const currentWd = website.websiteData
            ? JSON.parse(JSON.stringify(website.websiteData))
            : null;
          if (currentWd) {
            if (
              typeof safeData.brandLogo === "string" &&
              safeData.brandLogo.startsWith("font:")
            ) {
              currentWd.logoFont = safeData.brandLogo.replace("font:", "");
              delete currentWd.logoImageUrl;
            } else if (
              typeof safeData.brandLogo === "string" &&
              safeData.brandLogo.startsWith("url:")
            ) {
        ...
        if (safeData.headlineFont) {
          const currentWd = website.websiteData
            ...
            : null;
          if (currentWd) {
            currentWd.designTokens = {
              ...(currentWd.designTokens || {}),
              headlineFont: safeData.headlineFont,
            };
            await updateWebsite(input.websiteId, { websiteData: currentWd });
          }
        }
        ...
        if (safeData.colorScheme) {
          ...
          if (updatedCs.primary)
            updatedCs.onPrimary = getContrastColor(updatedCs.primary);
          if (updatedCs.secondary)
            updatedCs.onSecondary = getContrastColor(updatedCs.secondary);
          if (updatedCs.accent)
            updatedCs.onAccent = getContrastColor(updatedCs.accent);
          if (updatedCs.surface)
            updatedCs.onSurface = getContrastColor(updatedCs.surface);
          if (updatedCs.background)
            updatedCs.onBackground = getContrastColor(updatedCs.background);
    ...
    complete: publicProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const effectiveCategory =
          (onboarding as any).businessCategory ||
          (website as any).business?.category ||
          "Dienstleistung";
        ...
        const savedSectionOrder: string[] | undefined = (onboarding as any)
          .sectionOrder;
        ...
        if (patchedData && (patchedData as any).sections) {
          ...
          if (savedHiddenSections && savedHiddenSections.length > 0) {
            secs = secs.filter(
              (s: any) => !savedHiddenSections.includes(s.type)
            );
          }
        ...
        if ((onboarding as any).businessCategory && website.businessId) {
          try {
            await updateBusiness(website.businessId, {
              category: (onboarding as any).businessCategory,
            });
          } catch {
            /* non-critical */
          }
        ...
        if (website.businessId) {
          ...
          if (Object.keys(bizUpd).length > 0) {
            try {
              await updateBusiness(website.businessId, bizUpd);
            } catch {
              /* non-critical */
            }
          }
        ...
        if (patchedColorScheme.primary)
          patchedColorScheme.onPrimary = getContrastColor(
            patchedColorScheme.primary
          );
        if (patchedColorScheme.secondary)
          patchedColorScheme.onSecondary = getContrastColor(
            patchedColorScheme.secondary
          );
        if (patchedColorScheme.accent)
          patchedColorScheme.onAccent = getContrastColor(
            patchedColorScheme.accent
          );
        if (patchedColorScheme.surface)
          patchedColorScheme.onSurface = getContrastColor(
            patchedColorScheme.surface
          );
        if (patchedColorScheme.background)
          patchedColorScheme.onBackground = getContrastColor(
            patchedColorScheme.background
          );
        ...
        if (onboarding.heroPhotoUrl)
          websiteUpdateData.heroImageUrl = onboarding.heroPhotoUrl;
        if (onboarding.aboutPhotoUrl)
          websiteUpdateData.aboutImageUrl = onboarding.aboutPhotoUrl;
        ...
        registerUmamiWebsite(website.slug, domain)
          .then(umamiId => {
            if (umamiId)
              updateWebsite(input.websiteId, { umamiWebsiteId: umamiId });
          })
          .catch(() => {
            /* non-critical */
          });
    ...
    uploadPhoto: publicProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const onboarding = await getOnboardingByWebsiteId(input.websiteId);
        const existingPhotos = Array.isArray(onboarding?.photoUrls)
    ...
    getPhotoSuggestions: publicProcedure
      .input(
        z.object({ category: z.string(), businessName: z.string().optional() })
      )
      .query(async ({ input }) => {
    ...
    getGmbPhotos: publicProcedure
      ...
      .query(async ({ input }) => {
        ...
        if (
          ...
          business.placeId.startsWith("email-")
        )
          return { photos: [] };
  ...
  customer: router({
    ...
    getImageSuggestions: protectedProcedure
      ...
      .query(async ({ ctx, input }) => {
        ...
        const stockPhotos = [...new Set([stockHero, ...stockGallery])].filter(
          Boolean
        ) as string[];
        return { stockPhotos };
      }),
    ...
    updateChatSettings: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        if (input.calendlyUrl !== undefined)
          updateData.calendlyUrl = input.calendlyUrl || null;
        if (input.chatWelcomeMessage !== undefined)
          updateData.chatWelcomeMessage = input.chatWelcomeMessage || null;
    ...
    saveTeamMembers: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        const currentWd = row.website.websiteData
          ? JSON.parse(JSON.stringify(row.website.websiteData))
          : {};
    ...
    updateWebsiteContent: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        if (seoDescription !== undefined)
          websiteData.seoDescription = seoDescription;
        // Patch sections
        if ((tagline || description) && Array.isArray(websiteData.sections)) {
          websiteData.sections = websiteData.sections.map((s: any) => {
            if (s.type === "hero") {
              return {
                ...s,
                headline: tagline ?? s.headline,
                subheadline: description ?? s.subheadline,
              };
            }
            return s;
          });
        ...
        if (input.patch.brandColor)
          colorScheme.primary = input.patch.brandColor;
        if (input.patch.brandSecondaryColor)
          colorScheme.secondary = input.patch.brandSecondaryColor;
        const updateData: any = { websiteData, colorScheme };
        if (heroPhotoUrl !== undefined) updateData.heroImageUrl = heroPhotoUrl;
        if (aboutPhotoUrl !== undefined)
          updateData.aboutImageUrl = aboutPhotoUrl;
        if (logoUrl !== undefined)
          websiteData.logoImageUrl = logoUrl === "" ? undefined : logoUrl;
...
- footer: { text, links[] }`;
        ...
        try {
          ...
          throw new TRPCError({
            code: "INTERNAL_SERVER_ERROR",
            message:
              "KI-Antwort konnte nicht verarbeitet werden. Bitte versuche es erneut.",
          });
        }
        ...
        const aiMessage: string =
          typeof updatedData._aiMessage === "string"
    ...
    updateServices: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        if (Array.isArray(websiteData.sections)) {
          ...
          const hasServicesSection = websiteData.sections.some(
            (s: any) => s.type === "services" || s.type === "features"
          );
    ...
    updateAddons: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        const websiteData = (website.websiteData as any) || {};
        let sections = Array.isArray(websiteData.sections)
        ...
        if (input.addOns.gallery?.enabled) {
          ...
          if (mode === "albums") {
            ...
            const galleryItems = (input.addOns.gallery.photos || []).map(
              (url: string) => ({ imageUrl: url, title: "" })
            );
            gallerySection = {
              type: "gallery",
              headline: "Galerie",
          ...
          if (!hasGallery) {
            ...
            sections = sections.map((s: any) =>
              s.type === "gallery" ? { ...s, ...gallerySection } : s
            );
          }
        ...
        if (input.addOns.pricelist?.enabled) {
          const hasPricelist = sections.some(
        ...
        if (/share\.google\//.test(url)) {
          try {
            ...
            const resolvedCategory =
              extractGmbCategory(detailsTypes || place.types) || null;
            ...
            try {
              ...
              const details = await makeRequest<PlaceDetailsResult>(
                "/maps/api/place/details/json",
                {
                  place_id: place.place_id,
                  fields:
                    "name,formatted_address,formatted_phone_number,rating,user_ratings_total,opening_hours,types,reviews",
                  language: "de",
                }
              );
              ...
              return {
                ...
                placeId: place.place_id,
                address:
                  rd?.formatted_address || place.formatted_address || null,
    ...
    generateWebsiteAsync: publicProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        runWebsiteGeneration(jobId, input.websiteId).catch(err => {
          console.error(
            `[Generation Job ${jobId}] Background generation failed:`,
            err
          );
        });
  ...
  "services": [
    { "title": "...", "description": "..." }
            ...
            messages: [
              {
                role: "system",
                content:
                  "Du bist ein Conversion-Texter, der das StoryBrand-Framework von Donald Miller beherrscht. Du schreibst deutsche Website-Texte, die Kunden als Helden positionieren und das Unternehmen als kompetenten Guide. Antworte AUSSCHLIESSLICH mit validem JSON.",
              },
        ...
        if (!content || typeof content !== "string") {
          throw new TRPCError({
            code: "INTERNAL_SERVER_ERROR",
            message: "LLM hat keinen Inhalt zurückgegeben",
          });
        }
        ...
        const currentWebsiteData = (website.websiteData || {}) as Record<
          string,
          any
        >;
        ...
        const generatedServices =
          generatedContent.services?.slice(0, 5).map((svc: any) => ({
        ...
        const generatedProcessSteps =
          generatedContent.processSteps
            ?.slice(0, 3)
        ...
        const updatedWebsiteData = {
          ...
          description:
            generatedContent.description || currentWebsiteData.description,
          sections:
            currentWebsiteData.sections?.map((section: any) => {
              ...
              if (section.type === "process" && generatedProcessSteps) {
                return {
                  ...section,
                  headline:
                    generatedContent.processHeadline || section.headline,
        ...
        const industryKey = await classifyIndustry(
          businessCategory,
          businessName
        );
        const reColorScheme = getIndustryColorScheme(
          businessCategory,
          businessName,
          industryKey
        );
        const reHeroImageUrl = getHeroImageUrl(
          businessCategory,
          businessName,
          industryKey
        );
        const { pool: reLayoutPool } = getLayoutPool(
          businessCategory,
          businessName,
          industryKey
        );
        const reLayoutStyle =
          (website as any).layoutStyle ||
          (await getNextLayoutForIndustry(industryKey, reLayoutPool));
